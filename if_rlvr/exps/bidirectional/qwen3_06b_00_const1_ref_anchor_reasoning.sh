#!/usr/bin/env bash
# Resume a Qwen3-0.6B ref-anchor reasoning ablation with pyx coeff 0.0.
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_06b_if_grpo_vllm_fsdp_think_true_pyx_anchor_0.0_pxy_0.0_clip_use_bsz_512_const1only_refanchor_cached_refpolicy_qwen3_06b}
