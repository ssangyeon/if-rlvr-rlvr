#!/usr/bin/env bash
# Qwen3-1.7B reasoning policy with the existing 1.7B non-reasoning final-answer
# anchor cache, rescored by the Qwen3-1.7B reference policy.
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_17b_grpo_think_pyx01_t17banchor_s17b_b1024_c1}
