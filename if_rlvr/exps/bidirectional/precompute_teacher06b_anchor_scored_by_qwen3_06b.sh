#!/usr/bin/env bash
# Freshly generate 0.6B non-reasoning anchor answers y0/y1 and score them
# with the same Qwen3-0.6B reference policy.
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_06b_precompute_teacher06b_nonreason_anchor_scored_by_qwen3_06b}
