...
export IF_DATA_SEED=3
export IF_REF_ANCHOR_CACHE_PATH=${IF_REF_ANCHOR_CACHE_PATH:-${CACHE_ROOT}/if_ref_anchor_teacher17b_nonreason_train_seed3_val512_scored_by_qwen3_17b.json}
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_17b_precompute_teacher17b_nonreason_anchor_scored_by_qwen3_17b_seed3}
