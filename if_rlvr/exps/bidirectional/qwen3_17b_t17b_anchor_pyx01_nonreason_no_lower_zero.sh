...
# Ablation: remove the lower x-only zero anchor; PPL <= x+c anchor gets +0.1.
...
export IF_PPL_ANCHOR_REWARD_MODE=${IF_PPL_ANCHOR_REWARD_MODE:-no_lower_zero}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_17b_grpo_nonthink_pyx01_t17banchor_no_lowerzero_s17b_b1024_c1}
