#!/usr/bin/env bash
# Resume a Qwen3-0.6B ref-anchor reasoning ablation with pyx coeff 1.0.
...
export PY_GIVEN_X_REWARD_COEFF=${PY_GIVEN_X_REWARD_COEFF:-1.0}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_06b_if_grpo_vllm_fsdp_think_true_pyx_anchor_1.0_pxy_0.0_clip_use_bsz_512_const1only_refanchor_resume_precompute_refpolicy_qwen3_06b}
