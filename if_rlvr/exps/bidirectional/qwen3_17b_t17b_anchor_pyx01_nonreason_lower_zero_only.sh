...
# Ablation: remove the upper x+c bonus anchor; only PPL below x-only zeroes reward.
...
export IF_PPL_ANCHOR_REWARD_MODE=${IF_PPL_ANCHOR_REWARD_MODE:-lower_zero_only}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_17b_grpo_nonthink_pyx01_t17banchor_lowerzeroonly_s17b_b1024_c1}
