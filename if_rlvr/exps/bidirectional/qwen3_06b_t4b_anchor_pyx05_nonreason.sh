#!/usr/bin/env bash
# Qwen3-0.6B non-reasoning policy with 4B non-reasoning final-answer anchors,
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_06b_grpo_nonthink_pyx05_t4banchor_s06b_b1024_c1}
