...
export PY_GIVEN_X_REWARD_COEFF=${PY_GIVEN_X_REWARD_COEFF:-0.7}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_06b_grpo_nonthink_pyx07_t06banchor_s06b_b1024_c1}
