...
export CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-${GPU_SET}}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-qwen3_17b_grpo_nonthink_pyx05_t17banchor_s17b_b1024_c1}

exec bash "${SCRIPT_DIR}/qwen3_4b_01_00_const1_ref_anchor_reasoning_workspace.sh"
