#!/usr/bin/env bash
# GRPO for allenai/Olmo-3-7B-Instruct-DPO with constraint-only IF reward.
...
export IF_RLVR_RUN_ID=${IF_RLVR_RUN_ID:-olmo3_7b_constraint_only_slot${RUN_SLOT}}
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-olmo3_7b_grpo_nonthink_constraint_only_b1024_c1}
